...
#define SETUP_MUTABLE_ITERATOR(C, T, S)              \
  typedef tmc::foundation::iterator<C, T, S> iterator;  \
  iterator begin() { return iterator::begin(this); } \
  iterator end()   { return iterator::end(this);   }

// Use this define to declare only `const_iterator`
#define SETUP_CONST_ITERATOR(C, T, S)                                  \
  typedef tmc::foundation::const_iterator<C, T, S> const_iterator;        \
...
#define SETUP_MUTABLE_RITERATOR(C, T, S) \
  typedef tmc::foundation::iterator<C, T, S##_reversed > reverse_iterator; \
...
#define SETUP_CONST_RITERATOR(C, T, S)                                              \
  typedef tmc::foundation::const_iterator<C, T, S##_reversed > const_reverse_iterator; \
...
// The non-specialized version is used for T=rvalue:
        ...
        public:
            ...
            bool operator!=(const iterator &other) const {
                return state.pos != other.state.pos;
            }
            ...
            friend class tmc::foundation::const_iterator<C, T, S>;
...
// The non-specialized version is used for T=rvalue:
        ...
        public:
            ...
            friend class tmc::foundation::iterator<C, T, S>;
